...
?>
  ...
  <!-- SECTION LIST JABATAN -->
    <h3 class="text-uppercase">list data jabatan</h3>
  <main >
    <div class="row">
    <div class="col-5">
    <form action="" method="get">
    <div class="input-group ">
      <input type="text" name="page" value="data-jabatan" hidden >
    ...
    <div class="col-3 offset-4">
     <div>
      <a href="index.php?page=add-jabatan" data-toggle="tambah" data-placement="right" title="tambah data"><button type="submit" class="btn btn-outline-success float-end ">
        + Tambah Data
      </button></a>
     </div>
    </div>
...
<br>
  ...
  <?php
    if(isset($_GET['nama'])){
      $nama = $_GET['nama'];
      $data = "SELECT * FROM tb_jabatan WHERE position LIKE '%$nama%'"; 
      $result = $connect->query($data); 
      }else{
      $data = " SELECT * FROM tb_jabatan ";
      $result = $connect->query($data);  
      }
      $no = 1;
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <a href="index.php?id=<?php echo $row['id']?>&page=delete-jabatan"><button type="button" class="btn btn-outline-danger">Oke</button></a>
