                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            include "../config/koneksi.php";
                                    ...
                                    $select= mysqli_query($connect, "select * from tb_karyawan");
                            ...
                            <tr>
                                ...
                                <td><?php echo $data['id_position']; ?></td>
                                <td><?php echo $data['id_shift']; ?></td>
                                <td>
                                    <a href="index.php?page=data-karyawan?id=<?php echo $data['id']; ?>" class="btn btn-sm btn-danger alert_notif">Hapus</a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
